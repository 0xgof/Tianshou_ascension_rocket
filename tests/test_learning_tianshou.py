...
from learning.tianshou import (MODEL_A, MODEL_B, MODEL_C, GaussianPolicyConfig,
                               NetworkConfig, build_named_model, make_encoded_env)
...
def test_tianshou_ppo_saves_metrics_and_checkpoint(tmp_path):
    ...
    assert checkpoint_path.parent == tmp_path / "checkpoints" / MODEL_C
    ...
    assert checkpoint_path.stem == metrics_path.stem
